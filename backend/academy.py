...
_FIELDS: list[AcademicField] = [
    ...
    AcademicField(id="sociology", name="Sociología", category="Humanidades", icon="chat", description="Comportamiento social, grupos y estructuras de poder.", tutor_name="Socra"),
    ...
    AcademicField(id="international-relations", name="Relaciones Internacionales", category="Negocios", icon="trophy", description="Diplomacia, tratados y geopolítica global.", tutor_name="Ambassador"),
    ...
    AcademicField(id="journalism", name="Periodismo", category="Humanidades", icon="chat", description="Investigación, ética y comunicación de masas.", tutor_name="Press"),
